  ...
  return (
    <div className="flex flex-col lg:flex-row-reverse space-y-4 dark:text-white">
      ...
      <div className="flex-1 space-y-6">
        {/* Shoe text details */}
        <div className="text-5xl md:text-9xl font-black">{shoe.title}</div>
        ...
        <div className="space-x-10">
          <button
            ...
            className="
            btn-press-anim w-44 h-14 bg-black text-white hover:bg-gray-900
          active:bg-gray-700 duration-300 dark:bg-white dark:text-black
            "
          >
            Add to bag
          </button>
